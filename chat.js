/* ===== Städlinjen AB – Säljchatt (skriptad, $0, ingen AI-nyckel) =====
...
(function () {
  ...
  const flow = [
    {
      bot: "Hej och välkommen till Städlinjen! 👋 Vad behöver du hjälp med?",
  ...
  wrap.innerHTML = `
    ...
    <div class="slc__panel" id="slcPanel">
      <div class="slc__head">
        ...
        <div><strong>Städlinjen AB</strong><span>Svarar direkt · ⭐ 4,9</span></div>
